  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers: { color: string; make: string; model: string; year: string; weight: string; topSpeed: string; frontWheelDiameter: string; frontWheelBrand: string; rearWheelDiameter: string; rearWheelBrand: string;}) => {
        ...
        // creates two wheel objects representing the front and rear wheels
  ...
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers: { vehicleToTow: any; }) => {
        ...
        // checks if its a Truck object before towing
    ...
    inquirer
      ...
      .then((answers: { action: string; }) => {
        ...
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          //find selected motorbike and perform a wheelie
          const selectedVehicle = this.vehicles.find(v => v.vin === this.selectedVehicleVin);
